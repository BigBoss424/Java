public class AssociateMember
{
	...
	public AssociateMember()
	{
		...
		this.minutesDone = 0;
		this.name = "default associate member";
	}
	
	//EVC
	public AssociateMember(int hL, int hR, int hD, int mL, int mR, int mD, String n)
	{
		this.hoursLeft = hL;
	...
	//Gotta create helper classes to get the integer values for hoursLeft and hoursRequired.
	//It should be simply 
